...
import { MessageSquare, Trash2, X, Search, XCircle, User as UserIcon, LogOut, Menu, Plus, LibraryBig } from 'lucide-react';
    ...
    <>
      ...
      `}>
        <div className="flex flex-col h-full min-w-80">
          ...
          <div className="flex items-center justify-between px-4 pt-4 bg-gray-900/95 backdrop-blur-sm">
          ...
          {/* Library Links */}
          <div className="px-2 py-2 border-b border-gray-700 bg-gray-900/95">
            <Link
              href="/chat/gallery"
              className="flex items-center gap-3 p-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-all duration-200 group"
            >
              <svg className="w-5 h-5 text-blue-400 group-hover:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
              <div>
                <div className="text-sm font-medium">File Gallery</div>
                <div className="text-xs text-gray-500">View your uploaded files</div>
              </div>
            </Link>
          </div>
          {/* Search Bar */}
